...
const sections: NavSection[] = [
  { id: 'factorial-intro', label: 'Why Factorial Designs?' },
  { id: 'main-effects', label: 'Main Effects' },
  { id: 'interaction', label: 'The Interaction' },
  { id: 'variance-partitioning', label: 'Partitioning Variance' },
];

export default function NavigationPane() {
  const [activeSection, setActiveSection] = useState<string>('factorial-intro');
